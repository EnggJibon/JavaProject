 ...
 */
@Embeddable
public class TblMachineInspectionResultPK implements Serializable {
    ...
    public TblMachineInspectionResultPK() {
    }

    public TblMachineInspectionResultPK(String maintenanceDetailId, int seq, String inspectionItemId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblMachineInspectionResultPK)) {
            return false;
        }
        TblMachineInspectionResultPK other = (TblMachineInspectionResultPK) object;
    ...
    public String toString() {
        return "com.kmcj.karte.resources.machine.TblMachineInspectionResultPK[ maintenanceDetailId=" + maintenanceDetailId + ", seq=" + seq + ", inspectionItemId=" + inspectionItemId + " ]";
    }
