 ...
 */
@Embeddable
public class TblMachineRemodelingInspectionResultPK implements Serializable {
    ...
    public TblMachineRemodelingInspectionResultPK() {
    }

    public TblMachineRemodelingInspectionResultPK(String remodelingDetailId, int seq, String inspectionItemId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TblMachineRemodelingInspectionResultPK)) {
            return false;
        }
        TblMachineRemodelingInspectionResultPK other = (TblMachineRemodelingInspectionResultPK) object;
    ...
    public String toString() {
        return "com.kmcj.karte.resources.machine.remodeling.inspection.TblMachineRemodelingInspectionResultPK[ remodelingDetailId=" + remodelingDetailId + ", seq=" + seq + ", inspectionItemId=" + inspectionItemId + " ]";
    }
