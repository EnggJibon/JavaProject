...
/**
 * メンテサイクル用MstMachine。パフォーマンス調整用にメンテサイクルバッチに必要なフィールドのみを抜粋。
 * @author t.takasaki
 */
@Entity
...
public class MstMachineForBatch implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MstMachineForBatch)) {
            return false;
        }
        MstMachineForBatch other = (MstMachineForBatch) object;
    ...
    public String toString() {
        return "com.kmcj.karte.batch.maintenance.cycle.MstMachineForBatch[ id=" + uuid + " ]";
    }
